...
<div id="wrap" class="wrap">
		...
		<div id="owl-demo" class="owl-carousel owl-theme">
			<div class="item">
				...
				<h2>건물설계 컨설팅에서 시설관리까지<br><strong>앞서나가는 종합 건설, 이안베스트</strong></h2>
		...
		<div class="double-set"> 
		 <div class="txt-box full-page"><div class="section-header"><p>IANBEST DESIGN</p><h2 class="white">10년간의 전문시설 건축 노하우<br>종합건설 이안베스트</h2></div><div class="txt-area"><p class="white low-weight">이안베스트는 급변하는 환경안에서<br>사용자들의 관계를 이해하고 건축의 목적을 이루고자 노력합니다.<br>클라이언트들과 끊임없이 소통하고 의견을 조율하면서<br>최상의 공간을 창조하는 것이 우리의 목표입니다. </p><button class="btnS" type="button" onclick="location.href='work-lime.html'">MORE VIEW</button></div></div>
...
">MORE VIEW</button></div></div>
		...
		<p>처음부터 끝까지 관리하는 이안베스트</p></div></div>
