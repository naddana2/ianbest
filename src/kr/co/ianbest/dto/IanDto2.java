...
package kr.co.ianbest.dto;

public class IanDto2 {
	...
	public void setPop_switch(String pop_switch) {
		this.pop_switch = pop_switch;
	}
	...
	public String getPort_division() {
		return port_division;
	}
	...
	public String getPort_engname() {
		return port_engname;
	}
	public void setPort_engname(String port_engname) {
		this.port_engname = port_engname;
	}
